...
const quizData = [
    ...
    { q: "من هو المسؤول التنفيذي الأعلى داخل نادي الأتحاد السكندري والمكلف بالإشراف على سير العمل الإداري اليومي وتنفيذ قرارات مجلس الإدارة؟؟", options: ["أمين الصندوق", "مدير الأمن", " المدير التنفيذي للنادي", "مدير النشاط الرياضي"], correct: 2 },
